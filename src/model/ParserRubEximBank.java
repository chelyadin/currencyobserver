...
public class ParserRubEximBank implements BankParserInfc {

	private static ParserRubEximBank instance;
	private boolean used;

	private ParserRubEximBank() {
		used = false;
	}

	public static synchronized BankParserInfc getInstance() {
		if (instance == null) {
			instance = new ParserRubEximBank();
			return instance;
		}
		return instance;
	}
