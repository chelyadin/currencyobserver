...
public class ParserEurEximBank implements BankParserInfc {

	private static ParserEurEximBank instance;

	private boolean used;

	private ParserEurEximBank() {
		used = false;
	}

	public static synchronized BankParserInfc getInstance() {
		if (instance == null) {
			instance = new ParserEurEximBank();
			return instance;
		}
		return instance;
	}
