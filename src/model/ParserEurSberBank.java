...
public class ParserEurSberBank implements BankParserInfc {

	private static ParserEurSberBank instance;
	private boolean used;

	private ParserEurSberBank() {
		used = false;
	}

	public static synchronized BankParserInfc getInstance() {
		if (instance == null) {
			instance = new ParserEurSberBank();
			return instance;
		}
		return instance;
	}
	...
	public Currency makeCurrency() {
		...
		try {
			...
			Element targCurrency = allCurrencies.get(2);
