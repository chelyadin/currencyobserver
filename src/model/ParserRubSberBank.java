...
public class ParserRubSberBank implements BankParserInfc {

	private static ParserRubSberBank instance;
	private boolean used;

	private ParserRubSberBank() {
		used = false;
	}

	public static synchronized BankParserInfc getInstance() {
		if (instance == null) {
			instance = new ParserRubSberBank();
			return instance;
		}
		return instance;
	}
