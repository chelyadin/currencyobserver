...
public class ParserUsdPrivatBank implements BankParserInfc {

	private static ParserUsdPrivatBank instance;
	private boolean used;

	private ParserUsdPrivatBank() {
		used = false;
	}

	public static synchronized BankParserInfc getInstance() {
		if (instance == null) {
			instance = new ParserUsdPrivatBank();
			return instance;
		}
		return instance;
	}
	...
	public Currency makeCurrency() {
		...
		try {
			...
			Element targCurrency = allCurrencies.get(5);
