...
public class ParserRubPrivatBank implements BankParserInfc {

	private static ParserRubPrivatBank instance;
	private boolean used;

	private ParserRubPrivatBank() {
		used = false;
	}

	public static synchronized BankParserInfc getInstance() {
		if (instance == null) {
			instance = new ParserRubPrivatBank();
			return instance;
		}
		return instance;
	}
	...
	public Currency makeCurrency() {
		...
		try {
			...
			Element targCurrency = allCurrencies.get(6);
